        ...
        Dicebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ScoreEm >= 9){
                    ...
                    if(ScoreEm + check > 12){
                       ...
                       // STdice.setText("Dice : " + zero);
                        ...
                        enemyLP.setImageResource(R.drawable.twentyhpm);
                    ...
                    if(EmLP == 20){
                        ...
                        enemyLP.setImageResource(R.drawable.nineteenhpm);
                    }
                    else if(EmLP == 18){
                        enemyLP.setImageResource(R.drawable.eightteenhpm);
                    }
                    else if(EmLP == 17){
                        enemyLP.setImageResource(R.drawable.seventeenhpm);
                    }
                    else if(EmLP == 16){
                        enemyLP.setImageResource(R.drawable.sixteenhpm);
                    }
                    else if(EmLP == 15){
                        enemyLP.setImageResource(R.drawable.fifteenhpm);
                    }
                    else if(EmLP == 14){
                        enemyLP.setImageResource(R.drawable.fourteenhpm);
                    }
                    else if(EmLP == 13){
                        enemyLP.setImageResource(R.drawable.thirteenhpm);
                    }
                    else if(EmLP == 12){
                        enemyLP.setImageResource(R.drawable.twelehpm);
                    }
                    else if(EmLP == 11){
                        enemyLP.setImageResource(R.drawable.elevenhpm);
                    }
                    else if(EmLP == 10){
                        enemyLP.setImageResource(R.drawable.tenhpm);
                    }
                    else if(EmLP == 9){
                        enemyLP.setImageResource(R.drawable.ninehpm);
                    }
                    else if(EmLP == 8){
                        enemyLP.setImageResource(R.drawable.eighthpm);
                    }
                    else if(EmLP == 7){
                        enemyLP.setImageResource(R.drawable.sevenhpm);
                    }
                    else if(EmLP == 6){
                        enemyLP.setImageResource(R.drawable.sixhpm);
                    }
                    else if(EmLP == 5){
                        enemyLP.setImageResource(R.drawable.fivehpm);
                    }
                    else if(EmLP == 4){
                        enemyLP.setImageResource(R.drawable.fourhpm);
                    }
                    else if(EmLP == 3){
                        enemyLP.setImageResource(R.drawable.threehpm);
                    }
                    else if(EmLP == 2){
                        enemyLP.setImageResource(R.drawable.twohpm);
                    }
                    else if(EmLP == 1){
                        enemyLP.setImageResource(R.drawable.onehpm);
                    }
                ...
                if(Score > 12 ){
                    ...
                    if(UserLP == 20){
                        userLP.setImageResource(R.drawable.twentyhpm);
                    }
                    else if(UserLP == 19){
                        userLP.setImageResource(R.drawable.nineteenhpm);
                    }
                    else if(UserLP == 18){
                        userLP.setImageResource(R.drawable.eightteenhpm);
                    }
                    else if(UserLP == 17){
                        userLP.setImageResource(R.drawable.seventeenhpm);
                    }
                    else if(UserLP == 16){
                        userLP.setImageResource(R.drawable.sixteenhpm);
                    }
                    else if(UserLP == 15){
                        userLP.setImageResource(R.drawable.fifteenhpm);
                    }
                    else if(UserLP == 14){
                        userLP.setImageResource(R.drawable.fourteenhpm);
                    }
                    else if(UserLP == 13){
                        userLP.setImageResource(R.drawable.thirteenhpm);
                    }
                    else if(UserLP == 12){
                        userLP.setImageResource(R.drawable.twelehpm);
                    }
                    else if(UserLP == 11){
                        userLP.setImageResource(R.drawable.elevenhpm);
                    }
                    else if(UserLP == 10){
                        userLP.setImageResource(R.drawable.tenhpm);
                    }
                    else if(UserLP == 9){
                        userLP.setImageResource(R.drawable.ninehpm);
                    }
                    else if(UserLP == 8){
                        userLP.setImageResource(R.drawable.eighthpm);
                    }
                    else if(UserLP == 7){
                        userLP.setImageResource(R.drawable.sevenhpm);
                    }
                    else if(UserLP == 6){
                        userLP.setImageResource(R.drawable.sixhpm);
                    }
                    else if(UserLP == 5){
                        userLP.setImageResource(R.drawable.fivehpm);
                    }
                    else if(UserLP == 4){
                        userLP.setImageResource(R.drawable.fourhpm);
                    }
                    else if(UserLP == 3){
                        userLP.setImageResource(R.drawable.threehpm);
                    }
                    else if(UserLP == 2){
                        userLP.setImageResource(R.drawable.twohpm);
                    }
                    else if(UserLP == 1){
                        userLP.setImageResource(R.drawable.onehpm);
                    }
